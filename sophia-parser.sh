...
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/rdm_regions_page_data.txt" -force -notitle -summary:"$SUMMARY"
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/rdm_areas_page_data.txt" -force -notitle -summary:"$SUMMARY"
...
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/progression_materials_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing rare material data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/rare_materials_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing gatherable data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/gatherables_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing natural data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/naturals_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing aic product data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/aic_products_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing facility data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/facilities_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing quest item data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/quest_items_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing gift data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/gifts_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing seed data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/seeds_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing container data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/containers_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing consumable data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/consumables_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing package data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/packages_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing system blueprint data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/system_blueprints_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing formula data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/formulas_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing photo data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/photo_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing profile data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/profile_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing etchspace data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/etchspace_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing sanity data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/sanity_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing currency data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/currency_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing headhunting data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/headhunting_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing miscellaneous data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/miscellaneous_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing personal device data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/personal_device_page_data.txt" -force -notitle -summary:"$SUMMARY"
echo "Pushing ornamental data to the wiki..."
python3 pwb.py pagefromfile -file:"$PARSER_DIR/output/ornamental_page_data.txt" -force -notitle -summary:"$SUMMARY"
